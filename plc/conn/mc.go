...
// MitsubishiClient 구조체: PLC 연결 및 통신을 관리합니다.
// Connect(), Close(), ReConnect() 메서드: PLC와의 연결을 관리합니다.
// Read() 및 Write() 메서드: PLC의 데이터를 읽고 쓰는 기본 함수입니다.
// ReadBool(), ReadInt16(), ReadUInt16() 등: 특정 데이터 타입을 읽는 편의 함수들입니다.
// WriteValue(): 다양한 데이터 타입을 PLC에 쓰는 함수입니다.
// GetReadCommand_Qna_3E(), GetWriteCommand_Qna_3E() 등: 프로토콜별 명령어를 생성하는 함수들입니다.
// ConvertArg_Qna_3E(), ConvertArg_A_1E(): 주소 문자열을 PLC 주소 형식으로 변환하는 함수들입니다.
